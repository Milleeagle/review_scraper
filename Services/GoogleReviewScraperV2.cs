...
public class GoogleReviewScraperV2 : IReviewScraper, IDisposable
{
    private readonly IWebDriver _driver;
    private readonly WebDriverWait _wait;
    private readonly ILogger<GoogleReviewScraperV2> _logger;
    private bool _disposed = false;

    public GoogleReviewScraperV2(ILogger<GoogleReviewScraperV2> logger)
    {
        _logger = logger;
